...
class Product extends Model
{
    ...
    {
        return $this->hasMany('App\Models\ProductDetailVideo', 'products_id', 'id')->join('video_sessions', 'video_sessions.id', '=', 'product_detail_videos.video_sessions_id')->orderBy('video_sessions.start_date', 'desc')->orderBy('start_time', 'desc');
    }
